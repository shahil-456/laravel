...
<body>
    ...
    <div class="flex wrapper">
        ...
        .bg-white {
        --tw-bg-opacity: 1;
        background-color: rgb(198, 185, 150);
        }
          </style>
        ...
        <main class="flex-grow p-6">
            ...
            <div class="flex items-center max-w-md mx-auto mt-4">
                ...
                type="text" 
                placeholder="Search..." 
                class="form-input mb-4 w-full border p-2" 
                id="searchInput"
              />
              ...
              <div class="grid lg:grid-cols-2 grid-cols-1 gap-4">
                <div class="col-span-2">
                    <div class="card">
                        <div id="productList" class="flex flex-wrap gap-4">
                            @foreach($products as $item)
                            <div 
                                class="product-card flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md" 
                                data-name="{{ strtolower($item->name) }}"
                            >
                                <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                                    <img class="object-cover" src="{{ asset('storage/' . $item->image) }}" />
                                </a>
            
                                <div class="mt-4 px-5 pb-5">
                                    <a href="#">
                                        <h5 class="text-2xl tracking-tight text-slate-900">{{ $item->name }}</h5>
                                    </a>
                                    <div class="mt-2 mb-3">
                                        <p><span class="text-1xl font-bold text-slate-900">Price-₹{{ $item->price }}</span></p>
                                    </div>
                                    <div class="text-end">
                                        <a href="{{ route('product-details', $item->id) }}">
                                            <button type="button" class="btn bg-primary text-white">Details</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
