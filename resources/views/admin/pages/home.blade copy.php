                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="{{ asset("knorix/assets/images/users/avatar-1.jpg") }}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="{{ asset("knorix/assets/images/users/avatar-2.jpg") }}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="{{ asset("knorix/assets/images/users/avatar-3.jpg") }}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="{{ asset("knorix/assets/images/users/avatar-4.jpg") }}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="{{ asset("knorix/assets/images/users/avatar-5.jpg") }}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="{{ asset("knorix/assets/images/users/avatar-6.jpg") }}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="{{ asset("knorix/assets/images/users/avatar-7.jpg") }}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="{{ asset("knorix/assets/images/users/avatar-8.jpg") }}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="py-6">
                    <div class="px-6" data-simplebar style="max-height: 304px;">
                        <div class="space-y-6">
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{ asset("knorix/assets/images/users/avatar-1.jpg") }}" width="40" alt="Generic placeholder image">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{ asset("knorix/assets/images/users/avatar-2.jpg") }}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{ asset("knorix/assets/images/users/avatar-3.jpg") }}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{ asset("knorix/assets/images/users/avatar-4.jpg") }}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{ asset("knorix/assets/images/users/avatar-5.jpg") }}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{ asset("knorix/assets/images/users/avatar-6.jpg") }}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
