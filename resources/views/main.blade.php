...
<!-- Mirrored from themesbrand.com/qexal/layout/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Feb 2024 02:49:02 GMT -->
<head>
    ...
    <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="20" >
        ...
        <!--Navbar Start-->
        <nav class="navbar navbar-expand-lg navbar-custom navbar-light fixed-top" id="navbar">
            <div class="container">
                <!-- LOGO -->
                <a class="navbar-brand logo" href="index-1.html">
                    ...
                    <img src=" {{ asset('landing/images/logo-dark.png') }}" alt="" class="logo-dark" height="28" />
                    <img src="{{ asset('landing/images/logo-light.png') }}" alt="" class="logo-light" height="28" />
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="{{ route('signup') }}" class="btn btn-sm rounded-pill nav-btn ms-lg-3">Register</a>
                </div>
            </div>
            <!-- end container -->
        </nav>
        ...
        <!-- Hero Start -->
        <section class="hero-2 position-relative overflow-hidden" style="background-image: url(images/hero-2-bg.png);" id="home">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <span class="badge badge-soft-primary mb-4">Creative Design</span>
                        <h1 class="font-weight-semibold mb-4 hero-2-title">We Help Startups Launch Their Products</h1>
                        <p class="mb-5 text-muted">Nemo enim ipsam voluptatem quia voluptas sit aut aspernatur aut fugit sed quia consequuntur magni dolores ratione voluptatem nesciunt.</p>
                        <div class="custom-search">
                            <div class="input-group mb-lg-0 mb-4">
                                <input type="text" class="form-control rounded-pill" placeholder="Write to us" aria-label="Recipient's username" aria-describedby="button-addon2">
                                <div class="input-group-append">
                                  <button class="btn btn-sm btn-primary rounded-pill px-2" type="button" id="button-addon2"><i data-feather="chevron-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-10 mx-auto ms-lg-auto me-lg-0">
                        <div class="mt-lg-0 mt-4">
                            ...
                            <img src=" {{ asset('landing/images/hero-2-img.png') }}" alt="" class="img-xl-responsive" /> </div>
                    </div>
                    <!-- end col -->
                </div>
                <!-- end row -->
                    ...
                    <div class="col-md-6 ms-md-auto order-1 order-md-2">
                        <div class="position-relative">
                            <div class="ms-5 features-img">
                                ...
                                <img src=" {{ asset('landing/images/features-1.jpg') }}" alt="" class="img-fluid d-block mx-auto rounded shadow" />
                            </div>
                            <img src=" {{ asset('landing/images/dot-img.png') }}" alt="" class="dot-img-left" />
                        </div>
                    </div>
                    <!-- end col -->
                </div> 
                    ...
                    <div class="col-md-6">
                        <div class="position-relative mb-md-0 mb-5">
                            <div class="me-5 features-img">
                                ...
                                <img src="{{ asset('landing/images/features-2.jpg') }}" alt="" class="img-fluid d-block mx-auto rounded shadow" />
                            </div>
                            <img src="{{ asset('landing/images/dot-img.png') }}" alt="" class="dot-img-right" />
                        </div>
                    </div>
                    <!-- end col -->
                                        ...
                                        <div class="card plan-card mt-4 rounded text-center border-0 shadow overflow-hidden">
                                            <div class="card-body px-4 py-5">
                                                ...
                                                <div class="icon-mono avatar-md bg-soft-primary rounded mx-auto mb-5 p-3">
                                                    ...
                                                    <img src=" {{ asset('landing/images/pricing/1.png') }}" alt="" class="img-fluid d-block mx-auto" />
                                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card plan-card mt-4 rounded text-center border-0 shadow overflow-hidden">
                                            <div class="card-body px-4 py-5">
                                                ...
                                                <div class="icon-mono avatar-md bg-soft-primary rounded mx-auto mb-5 p-3">
                                                    <img src="{{ asset('landing/images/pricing/2.png') }}" alt="" class="img-fluid d-block mx-auto" />
                                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card plan-card mt-4 rounded text-center border-0 shadow overflow-hidden">
                                            <div class="card-body px-4 py-5">
                                                ...
                                                <div class="icon-mono avatar-md bg-soft-primary rounded mx-auto mb-5 p-3">
                                                    <img src="{{ asset('landing/images/pricing/3.png') }}" alt="" class="img-fluid d-block mx-auto" />
                                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-box mt-4 position-relative overflow-hidden rounded text-center shadow">
                            <div class="position-relative overflow-hidden">
                                <img src="{{ asset('landing/images/team/1.jpg') }}" alt="" class="img-fluid d-block mx-auto" />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-box mt-4 position-relative overflow-hidden rounded text-center shadow">
                            <div class="position-relative overflow-hidden">
                                <img src="{{ asset('landing/images/team/2.jpg') }}" alt="" class="img-fluid d-block mx-auto" />
                                <ul class="list-inline p-3 mb-0 team-social-item">
                                    <li class="list-inline-item mx-3">
                                        <a href="javascript: void(0);" class="team-social-icon h-primary"><i class="icon-sm" data-feather="facebook"></i></a>
                                    </li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-box mt-4 position-relative overflow-hidden rounded text-center shadow">
                            <div class="position-relative overflow-hidden">
                                <img src="{{ asset('landing/images/team/3.jpg') }}" alt="" class="img-fluid d-block mx-auto" />
                                <ul class="list-inline p-3 mb-0 team-social-item">
                                    <li class="list-inline-item mx-3">
                                        <a href="javascript: void(0);" class="team-social-icon h-primary"><i class="icon-sm" data-feather="facebook"></i></a>
                                    </li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-box mt-4 position-relative overflow-hidden rounded text-center shadow">
                            <div class="position-relative overflow-hidden">
                                <img src="{{ asset('landing/images/team/4.jpg') }}" alt="" class="img-fluid d-block mx-auto" />
                                <ul class="list-inline p-3 mb-0 team-social-item">
                                    <li class="list-inline-item mx-3">
                                        <a href="javascript: void(0);" class="team-social-icon h-primary"><i class="icon-sm" data-feather="facebook"></i></a>
                                    </li>
                        ...
                        <div class="card mt-4 border-0 shadow">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-center mt-4 pt-2">
                                    ...
                                    <img src="{{ asset('landing/images/user/img-2.jpg') }}" class="rounded-circle avatar-sm me-3" alt="..." />
                                    <div class="flex-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card mt-4 border-0 shadow">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit.</p>
                                <div class="d-flex align-items-center mt-4 pt-2">
                                    <img src="{{ asset('landing/images/user/img-3.jpg') }}" class="rounded-circle avatar-sm me-3" alt="..." />
                                    <div class="flex-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card mt-4 border-0 shadow">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit.</p>
                                <div class="d-flex align-items-center mt-4 pt-2">
                                    <img src="{{ asset('landing/images/user/img-1.jpg') }}" class="rounded-circle avatar-sm me-3" alt="..." />
                                    <div class="flex-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 ms-lg-auto">
                        <div class="mt-5 mt-lg-0">
                            ...
                            <img src="{{ asset('landing/images/contact.png') }}" alt="" class="img-fluid d-block" />
        ...
        <!-- Footer Start -->
        <footer class="footer" style="background-image: url({{ asset('landing/images/footer-bg.png') }});">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mb-4">
                            ...
                            <a href="index-1.html"><img src="{{ asset('landing/images/logo-light.png') }}" alt="" class="" height="30" /></a>
...
<!-- Mirrored from themesbrand.com/qexal/layout/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Feb 2024 02:49:10 GMT -->
</html>
