                ...
                <div class="p-6">
                    ...
                    @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2  gap-6">
                            ...
                            <div class="form-group">
                                <label for="contact" class="text-gray-800 text-sm font-medium inline-block mb-2">Link(optional)</label>

                                <input value="" name="link" type="text" class="form-input" id="link" placeholder="Link" >
                            </div>
