...
<body>
    ...
    <div class="flex wrapper">
            ...
            <header class="app-header flex items-center px-4 gap-3">
                ...
                <a href="index.html" class="logo-box">
                    ...
                    <div class="logo-light">
                        <img src="{{ asset("knorix/assets/images/logo-light.png") }}" class="logo-lg h-6" alt="Light logo">
                        <img src="{{ asset("knorix/assets/images/logo-sm.png") }}" class="logo-sm" alt="Small logo">
                    </div>

                    <!-- Dark Brand Logo -->
                    <div class="logo-dark">
                        <img src="{{ asset("knorix/assets/images/logo-dark.png") }}" class="logo-lg h-6" alt="Dark logo">
                        <img src="{{ asset("knorix/assets/images/logo-sm.png") }}" class="logo-sm" alt="Small logo">
                    </div>
                </a>
                ...
                <div class="relative">
                    <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link">
                        ...
                        <img src="{{asset('knorix/assets/images/users/user-6.jpg') }}" alt="user-image" class="rounded-full h-10">
                    ...
                    <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-0 w-44 z-50 transition-[margin,opacity] duration-300 mt-2 bg-white shadow-lg border rounded-lg p-2 border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <a class="flex items-center py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" href="{{ route('profile') }}">
        ...
        <main class="flex-grow p-6">
            ...
            <div class="flex items-center max-w-md mx-auto mt-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card p-6 bg-white rounded-lg shadow-md">
                            ...
                            <div class="flex flex-col md:flex-row gap-6">
                              ...
                              <!-- Image Left -->
                              <div class="md:w-1/2">
                                <img src="{{ asset('storage/' . $product->image) }}" class="w-72 h-auto rounded" />
                            </div>
                              ...
                              <div class="md:w-1/2 flex flex-col justify-between">
                                <div>
                                  ...
                                  <p class="text-gray-600 mb-4">Category: Product</p>


                                  <p class="text-white-600 mb-4">Seller: {{ $userdata->username }}</p>



                                  
                                  <p class="text-2xl font-semibold text-blue-600 mb-6">RS- ₹{{ $product->price }}</p>
                                ...
                                @if($product->link)
                                <a href="{{ Str::startsWith($product->link, ['http://', 'https://']) ? $product->link : 'https://' . $product->link }}" target="_blank" rel="noopener noreferrer">
                                    <p class="link">Link</p>
                                </a>
                                @endif
                            ...
                            <div class="mt-8">
                                ...
                                <a href="tel:{{ $product->contact }}" class="text-yellow-600 block mb-1">Call</a>
                                
                                <a href="https://wa.me/{{ $product->contact }}" target="_blank" class="text-green-600">WhatsApp</a>
                                    <br>
                                ...
                                @if($userdata->instagram)
                                    ...
                                    <a href="https://instagram.com/{{ $userdata->instagram }}/" target="_blank" class="text-pink-600">Instagram</a>
                                @endif
...
<script>
    ...
    <!-- Plugin Js -->
    <script src="{{ asset('knorix/assets/libs/simplebar/simplebar.min.js') }}"></script>
    <script src="{{ asset('knorix/assets/libs/feather-icons/feather.min.js') }}"></script>
    <script src="{{ asset('knorix/assets/libs/%40frostui/tailwindcss/frostui.js') }}"></script>
    
    <!-- App Js -->
    <script src="{{ asset('knorix/assets/js/app.js') }}"></script>
    
    <!-- Apexcharts js -->
    <script src="{{ asset('knorix/assets/libs/apexcharts/apexcharts.min.js') }}"></script>
    
    <!-- Dashboard Project Page js -->
    <script src="{{ asset('knorix/assets/js/pages/dashboard.js') }}"></script>
